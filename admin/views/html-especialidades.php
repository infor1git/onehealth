        ...
        <table class="wp-list-table widefat fixed striped">
            ...
            <tbody>
                ...
                if ( $items ) :
                    ...
                    <tr><td colspan="4">Nenhuma especialidade cadastrada.</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
            ...
            <table class="form-table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <label><input name="is_active" type="checkbox" value="1" <?php checked( $dados ? $dados->is_active : 1, 1 ); ?>> Ativo</label>
                        </td>
                    </tr>
                </tbody>
            </table>
